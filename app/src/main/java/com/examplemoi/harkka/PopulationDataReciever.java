...
public class PopulationDataReciever {

    public ArrayList<PopulationDataBuilder> getData(Context context, String municipality) {
        ...
        try {
            ...
            ArrayList<PopulationDataBuilder> populationData = new ArrayList<>();

            for(int i = 0; i < years.size(); i++) {
                populationData.add(new PopulationDataBuilder(Integer.valueOf(years.get(i)), Integer.valueOf(populations.get(i))));
            }
